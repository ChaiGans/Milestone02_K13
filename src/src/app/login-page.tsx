      ...
      <div className="bg-white rounded-lg xl:rounded-2xl w-[300px] h-[70%] md:w-[400px] xl:w-[30%] flex flex-col absolute py-10 px-10 md:py-16 md:px-16 justify-around">
        ...
        <div>
          <div className="flex justify-center items-center">
            <button className="font-latoregular font-normal bg-yellow-400 px-16 py-2 rounded-lg text-black text-xs mb-2 hover:cursor-pointer hover:bg-yellow-500 xl:text-xl xl:px-36 xl:py-5 xl:rounded-2xl shadow-md shadow-gray-400 xl:mb-10 xl:font-medium">
              Login
            </button>
          </div>
