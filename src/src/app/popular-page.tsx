...
export const Popular = () => {
    const [lomba, setLomba] = useState([ {
        ...
        "poster": "https://drive.google.com/uc?export=view&id=1-hJqoS2oay00RYZz987Hd6p11Lwm0Dkc",
       ...
       },
       {
        ...
        "poster": "https://drive.google.com/uc?export=view&id=1-Yq5XyXrMIc79ky4VfzE6hl56Heyjvzh",
        "userId": "9f4ab025-bf8f-4f31-84dd-5053cacc29cf"
       },
       {
        ...
        "price": 35000,
        "contact": "08157618448",
        "poster": "https://drive.google.com/uc?export=view&id=14VE-eql2_JKm4C6pAUDPJoY3vgZ4icLR",
        "userId": "9f4ab025-bf8f-4f31-84dd-5053cacc29cf"
       },
       {
        "id": "cc594a6d-f9e0-437c-bdb7-375daaa3889b",
        "name": "Lomba Cipta Lagu Anak",
        "description": "Lomba Cipta Lagu Anak adalah sebuah kompetisi kreatif di mana peserta diajak untuk menciptakan lagu yang ditujukan khusus untuk anak-anak. Lomba ini bertujuan untuk mendorong kreativitas peserta dalam menyusun lirik dan melodi lagu yang menarik, edukatif, dan menghibur bagi anak-anak.",
        "registrationDate": "15 Sept",
        "price": 0,
        "contact": "081933803658",
        "poster": "https://drive.google.com/uc?export=view&id=1QUyuxz6CvEpXDi8pTZaSt5peC6U8uFcC",
        "userId": "9f4ab025-bf8f-4f31-84dd-5053cacc29cf"
       },
       {
        ...
        "price": 0,
        "contact": "08111888932",
        "poster": "https://drive.google.com/uc?export=view&id=1nyluG7yDJ2TIfolOBTT5Wu6BLmz7w5sf",
        "userId": "9f4ab025-bf8f-4f31-84dd-5053cacc29cf"
       }])
    // useEffect(() => {
    ...
    return (
      <div>
        <div className="Sorting-Filtering flex justify-start gap-20 mb-10" >
            ...
            Sorted By <br/> <span className="font-bold text-[26px]">Paling Populer</span>
            </div>
        ...
        {lomba.map((competition)=>(
                <div className="card-display w-[200px] h-[420px] bg-transparent rounded-[20px] relative ">
                ...
                <div className="card-image rounded-tl-[20px] rounded-tr-[20px] h-[280px] bg-cover bg-center overflow-hidden relative mt-[20px]" style={{ backgroundImage: `url(${competition.poster})` }}>
                        <div className=" flex justify-center price rounded-tl-[10px] bg-yellow-500 inline-block relative w-[100px] h-[30px] top-[90%] left-[47%] items-center text-[12px]">Rp.{competition.price}</div>
                    </div>
                    <div className="card-description text-black text-center rounded-bl-[20px] rounded-br-[20px] bg-white py-[10px] overflow-hidden h-[140px] relative">
                        <h1 className="text-[14px] block h-[50px] font-bold flex item-center justify-center">{competition.name}</h1>
                        <p className="text-[14px] font-medium m-auto">Contact: {competition.contact}</p>
                        <a className="hover:bg-[#ccff33] active:bg-[#70e000] inline-block bg-[#9ef01a] px-[30px] py-[5px] mt-2 rounded-[10px] text-white absolute bottom-[10%] right-[20%]">Daftar</a>
                    </div>
                </div>
        ))}
            </div>
